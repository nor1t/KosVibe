...
export const discoveryLocations: DiscoveryLocation[] = [
  ...
  },
  {
    ...
    city: 'Ferizaj',
    region: { latitude: 42.3706, longitude: 21.1553, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'gjakova',
    label: 'Gjakova, Kosovo',
    city: 'Gjakova',
    region: { latitude: 42.3803, longitude: 20.4308, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'gjilan',
    label: 'Gjilan, Kosovo',
    city: 'Gjilan',
    region: { latitude: 42.4635, longitude: 21.4694, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'mitrovice',
    label: 'Mitrovice, Kosovo',
    city: 'Mitrovice',
    region: { latitude: 42.8914, longitude: 20.8656, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'vushtrri',
    label: 'Vushtrri, Kosovo',
    city: 'Vushtrri',
    region: { latitude: 42.8231, longitude: 20.9675, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'podujeve',
    label: 'Podujeve, Kosovo',
    city: 'Podujeve',
    region: { latitude: 42.9106, longitude: 21.1931, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'fushe-kosove',
    label: 'Fushe Kosove, Kosovo',
    city: 'Fushe Kosove',
    region: { latitude: 42.6394, longitude: 21.0961, latitudeDelta: 0.1, longitudeDelta: 0.1 },
  },
  {
    id: 'suhareke',
    label: 'Suhareke, Kosovo',
    city: 'Suhareke',
    region: { latitude: 42.3586, longitude: 20.825, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'rahovec',
    label: 'Rahovec, Kosovo',
    city: 'Rahovec',
    region: { latitude: 42.3994, longitude: 20.6547, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'malisheve',
    label: 'Malisheve, Kosovo',
    city: 'Malisheve',
    region: { latitude: 42.4822, longitude: 20.7458, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'skenderaj',
    label: 'Skenderaj, Kosovo',
    city: 'Skenderaj',
    region: { latitude: 42.7467, longitude: 20.7886, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'drenas',
    label: 'Drenas, Kosovo',
    city: 'Drenas',
    region: { latitude: 42.6283, longitude: 20.8939, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'lipjan',
    label: 'Lipjan, Kosovo',
    city: 'Lipjan',
    region: { latitude: 42.5217, longitude: 21.1258, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'kamenice',
    label: 'Kamenice, Kosovo',
    city: 'Kamenice',
    region: { latitude: 42.5781, longitude: 21.5803, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'viti',
    label: 'Viti, Kosovo',
    city: 'Viti',
    region: { latitude: 42.3214, longitude: 21.3583, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'kacanik',
    label: 'Kacanik, Kosovo',
    city: 'Kacanik',
    region: { latitude: 42.2319, longitude: 21.2594, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'shtime',
    label: 'Shtime, Kosovo',
    city: 'Shtime',
    region: { latitude: 42.4331, longitude: 21.0397, latitudeDelta: 0.1, longitudeDelta: 0.1 },
  },
  {
    id: 'obiliq',
    label: 'Obiliq, Kosovo',
    city: 'Obiliq',
    region: { latitude: 42.6869, longitude: 21.0703, latitudeDelta: 0.1, longitudeDelta: 0.1 },
  },
  {
    id: 'kline',
    label: 'Kline, Kosovo',
    city: 'Kline',
    region: { latitude: 42.6217, longitude: 20.5778, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'istog',
    label: 'Istog, Kosovo',
    city: 'Istog',
    region: { latitude: 42.78, longitude: 20.4875, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'decan',
    label: 'Decan, Kosovo',
    city: 'Decan',
    region: { latitude: 42.5402, longitude: 20.2879, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'dragash',
    label: 'Dragash, Kosovo',
    city: 'Dragash',
    region: { latitude: 42.0265, longitude: 20.6533, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'mamushe',
    label: 'Mamushe, Kosovo',
    city: 'Mamushe',
    region: { latitude: 42.3306, longitude: 20.7267, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'hani-i-elezit',
    label: 'Hani i Elezit, Kosovo',
    city: 'Hani i Elezit',
    region: { latitude: 42.1508, longitude: 21.2969, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'junik',
    label: 'Junik, Kosovo',
    city: 'Junik',
    region: { latitude: 42.4758, longitude: 20.2772, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'gracanice',
    label: 'Gracanice, Kosovo',
    city: 'Gracanice',
    region: { latitude: 42.6011, longitude: 21.1958, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'shterpce',
    label: 'Shterpce, Kosovo',
    city: 'Shterpce',
    region: { latitude: 42.2394, longitude: 21.0272, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'novoberde',
    label: 'Novoberde, Kosovo',
    city: 'Novoberde',
    region: { latitude: 42.6158, longitude: 21.4361, latitudeDelta: 0.1, longitudeDelta: 0.1 },
  },
  {
    id: 'partesh',
    label: 'Partesh, Kosovo',
    city: 'Partesh',
    region: { latitude: 42.4019, longitude: 21.4339, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'ranillug',
    label: 'Ranillug, Kosovo',
    city: 'Ranillug',
    region: { latitude: 42.4928, longitude: 21.5989, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'kllokot',
    label: 'Kllokot, Kosovo',
    city: 'Kllokot',
    region: { latitude: 42.3717, longitude: 21.3747, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'mitrovica-north',
    label: 'Mitrovica North, Kosovo',
    city: 'Mitrovica North',
    region: { latitude: 42.8956, longitude: 20.8664, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'zubin-potok',
    label: 'Zubin Potok, Kosovo',
    city: 'Zubin Potok',
    region: { latitude: 42.9144, longitude: 20.6897, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
  {
    id: 'zvecan',
    label: 'Zvecan, Kosovo',
    city: 'Zvecan',
    region: { latitude: 42.9075, longitude: 20.8403, latitudeDelta: 0.09, longitudeDelta: 0.09 },
  },
  {
    id: 'leposavic',
    label: 'Leposavic, Kosovo',
    city: 'Leposavic',
    region: { latitude: 43.1039, longitude: 20.8028, latitudeDelta: 0.11, longitudeDelta: 0.11 },
  },
];
